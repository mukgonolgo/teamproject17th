var map;
    ...
    function updateSubRegion() {
        ...
        if (region1 === 'seoul') {
            ...
            options = [
                ...
                {name: '팔달구', value: '37.276297,127.009249'}
            ];
        }
    ...
    function showMap() {
        ...
        // 선택한 지역의 좌표값을 가져옴
        var selectedRegionValue = document.getElementById('region2').value;
        var coordinates = selectedRegionValue.split(',');  // 좌표값을 분리
        ...
        if (!map) {
            ...
            var options = {
                center: new kakao.maps.LatLng(lat, lng),  // 선택한 지역의 좌표
                level: 5
            };
            ...
            map.setCenter(newCenter);  // 새로운 좌표로 중심 이동
        }
